...
Current Workstream: PTL-I100-114F-government-procurement-public-sites (ACTIVE; Stage2 government procurement public sites source adapter sixth cut. This packet may extend the 114A-114E public source adapter seam for government procurement public site notices and attachments, sandbox/local mirror fetch, raw snapshot metadata, hash/version/lineage, dedupe, retry/timeout, failure degrade, source health, and fetch audit. It does not use private or gray sources, bypass login/captcha/anti-bot controls, run uncontrolled live crawling, connect real providers, perform real outreach, payment, charge, delivery, refund, automated refund execution, external release, or push)
...
- Real external source fetch remains gated by dedicated Stage2 source adapter packets; 114A-114F only open allowlisted/sandbox public-source adapter readback, not uncontrolled live crawling
...
Current 114F Scope:
- Activate PTL-I100-114F as the sixth Stage2 real public source adapter subpacket under PTL-I100-114.
- Extend the 114A-114E adapter seam for government procurement public site notices and attachments: allowlisted/sandbox fetch abstraction, raw HTML/PDF/attachment snapshot metadata, hash/version/lineage, dedupe, retry/timeout, source health, and fetch audit.
...
- update Stage2 ingestion files listed by current_task for the 114F government procurement public sites adapter only
...
- update control/current_task.yaml, control/repo_status.md, control/product_task_library.yaml, and control/product_acceptance_checklist.yaml for 114F status
...
- PTL-I100-113, PTL-I100-114A, PTL-I100-114B, PTL-I100-114C, PTL-I100-114D, and PTL-I100-114E are completed; PTL-I100-114F is active as the sixth Stage2 public source adapter subpacket. PTL-I100-114G through PTL-I100-121 and PTL-I100-118 remain registered task-pool candidates. None is active until control/current_task.yaml explicitly activates it.
