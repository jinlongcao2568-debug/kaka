...
- run required checks and stop/report after check-task-packet / storage concurrency tests / API bootstrap tests / repository boundary tests / operability matrix tests / full tests / check-state-alignment
