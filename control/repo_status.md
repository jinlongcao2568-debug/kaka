...
Current Workstream: PTL-I100-102-stage1-5-real-source-vertical-slice (SCOPED_EXECUTION; activated as the current single-source Stage1-5 real-source vertical-slice packet; this packet allows scoped internal implementation inside its declared/allowed paths, does not auto-enter PTL-I100-103, and does not approve push, external release, Stage 8 real execution, or Stage 9 real payment / delivery / refund)
...
- Any docs/** change
- Any contracts/** / handoff/** / src/** / fixtures/** / tests/** change outside current task_packet allowed_modification_paths
- Any scripts/** change
...
- PTL-I100-102-stage1-5-real-source-vertical-slice is now the active scoped execution packet.
- PTL-I100-102 must stay single-source and Stage1-5-only for its first implementation slice; if it needs multi-source or Stage6+ expansion, it must stop and report.
- PTL-I100-103 is not auto-activated; current_mainline_next_candidate remains null until a dedicated future current_task packet is created.
