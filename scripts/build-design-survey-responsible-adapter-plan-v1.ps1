...
if (-not $OutputRoot) {
    $OutputRoot = Join-Path $repoRoot "tmp\evaluation-real-samples\design-survey-responsible-adapter-plan-v1"
}

$outputJson = Join-Path $OutputRoot "design-survey-responsible-adapter-plan-v1.json"
...
$argsList = @(
    "-m", "storage.design_survey_responsible_adapter_plan",
