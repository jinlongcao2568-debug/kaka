...
$previousEnv = @{
    ...
    KAKA_STORAGE_DATABASE_PASSWORD_FILE = $env:KAKA_STORAGE_DATABASE_PASSWORD_FILE
    KAKA_STORAGE_DATABASE_HOST = $env:KAKA_STORAGE_DATABASE_HOST
    KAKA_STORAGE_DATABASE_PORT = $env:KAKA_STORAGE_DATABASE_PORT
    KAKA_STORAGE_DATABASE_USER = $env:KAKA_STORAGE_DATABASE_USER
    KAKA_STORAGE_DATABASE_NAME = $env:KAKA_STORAGE_DATABASE_NAME
...
try {
    ...
    Remove-Item Env:KAKA_STORAGE_DATABASE_PASSWORD_FILE -ErrorAction SilentlyContinue
    Remove-Item Env:KAKA_STORAGE_DATABASE_HOST -ErrorAction SilentlyContinue
    Remove-Item Env:KAKA_STORAGE_DATABASE_PORT -ErrorAction SilentlyContinue
    Remove-Item Env:KAKA_STORAGE_DATABASE_USER -ErrorAction SilentlyContinue
    Remove-Item Env:KAKA_STORAGE_DATABASE_NAME -ErrorAction SilentlyContinue
