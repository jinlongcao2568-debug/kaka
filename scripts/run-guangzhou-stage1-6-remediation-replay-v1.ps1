...
if (-not $OutputRoot) {
    $OutputRoot = Join-Path $repoRoot "tmp\evaluation-real-samples\guangzhou-stage1-6-remediation-replay-v1"
}
...
$argsList = @(
    "-m", "storage.guangzhou_stage1_6_remediation_delta_report",
    "--mode", "run-replay",
