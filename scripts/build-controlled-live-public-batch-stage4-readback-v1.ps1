...
if (-not $OutputRoot) {
    $OutputRoot = Join-Path $repoRoot "tmp\evaluation-real-samples\controlled-live-public-batch-20260703-v1\stage4-readback"
}
...
$argsList = @(
    "-m", "runtime.controlled_live_public_batch_stage4_readback",
