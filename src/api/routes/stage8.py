...
STAGE8_OUTBOX_ROUTE_READINESS = {
    ...
    "stage8_live_pilot_readiness": {
        ...
        "readiness_scope": "gated_small_sample_live_pilot_readback",
        "pilot_scope_required": "small_sample",
        ...
        "requires_contact_source_audit": True,
        "requires_operator_approval": True,
        "requires_operator_action_audit": True,
        "requires_frequency_control": True,
        "requires_quiet_hours_check": True,
        "requires_opt_out_unsubscribe_check": True,
        "provider_unhealthy_suspends": True,
        "provider_rate_limited_suspends": True,
        "provider_timeout_suspends": True,
        "provider_circuit_open_suspends": True,
        "complaint_or_failure_threshold_suspends": True,
        "repository_backed_readback": True,
        "replayable": True,
    ...
    "stage8_approved_provider_execution_readiness": {
        "capability_state": "LIVE_READY",
        "readiness_scope": "approved_small_sample_provider_execution_readback",
