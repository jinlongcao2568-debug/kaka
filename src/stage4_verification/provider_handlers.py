...
GDCIC_SOURCE_TYPES_BY_PROVIDER = {
    GUANGDONG_THREE_LIBRARY: {"personnel_public_record", "performance_public_record"},
...
def build_stage4_provider_handlers(
    *,
    ...
    return {
        ...
        LOCAL_HOUSING_CONSTRUCTION: run_pending_provider_task,
        CONSTRUCTION_PERMIT: gdcic_handler,
        CONTRACT_FILING: gdcic_handler,
        COMPLETION_FILING: gdcic_handler,
        PROJECT_MANAGER_CHANGE: run_pending_provider_task,
...
def run_gdcic_backed_provider_task(
    ...
    *,
    ...
    relevant_results = [
        dict(result)
        for result in list(readback.get("source_results") or [])
