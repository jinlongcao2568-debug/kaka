...
GUANGDONG_CITY_RELEASE_EVIDENCE_SOURCE_CATALOG = {
    ...
    "CN-GD-HY": {
        ...
        "source_url": "https://www.heyuan.gov.cn/bmjy/hyszfhcxjsj/",
        "official_reference_url": "https://www.heyuan.gov.cn/",
        "runtime_status": "CITY_OFFICIAL_PORTAL_VERIFIED_ADAPTER_PENDING",
    ...
    "CN-GD-MM": {
        ...
        "source_url": "https://www.maoming.gov.cn/",
        "official_reference_url": "https://www.maoming.gov.cn/",
        "runtime_status": "CITY_OFFICIAL_PORTAL_VERIFIED_ADAPTER_PENDING",
            ...
            },
            {
                ...
                "verified_public_subsources": [
                    ...
                    },
                    {
                        ...
                        "source_name": "工程合同信用信息",
                        "source_url": "https://113.108.173.251:8080/",
                        "official_parent_url": "https://zfcj.gz.gov.cn/",
                        "target_source_types": ["contract_public_info"],
                        "runtime_status": "OFFICIAL_PORTAL_LINK_VERIFIED_ADAPTER_PENDING",
