...
class TestRuntimeGovernanceGuards(unittest.TestCase):
    def test_platform_infra_readiness_keeps_external_live_controlled_opening_requirements_locked(self) -> None:
        settings = Settings(
        ...
        self.assertTrue(controlled_opening_requirements["no_real_sales_outreach"])
        self.assertTrue(controlled_opening_requirements["no_real_payment"])
        self.assertTrue(controlled_opening_requirements["no_real_charge"])
        ...
        self.assertIn("provider.controlled_opening_requirement", monitoring["monitoring_readiness"]["component_ids"])
        ...
        self.assertFalse(production["controlled_opening_requirements"]["notification_enabled"])
        self.assertFalse(production["controlled_opening_requirements"]["real_alert_dispatch_enabled"])
        self.assertFalse(production["controlled_opening_requirements"]["external_paging_enabled"])
        ...
        self.assertFalse(production["controlled_opening_requirements"]["restore_execution_enabled"])
        self.assertFalse(production["controlled_opening_requirements"]["rollback_execution_enabled"])
        self.assertFalse(production["controlled_opening_requirements"]["active_storage_mutation_enabled"])
        self.assertFalse(production["controlled_opening_requirements"]["provider_call_enabled"])
        self.assertFalse(production["controlled_opening_requirements"]["real_provider_call_enabled"])
