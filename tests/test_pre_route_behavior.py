...
class TestPreRouteBehavior(unittest.TestCase):
    ...
    def test_stage8_invalid_contact_path_keeps_catalog_reason_and_no_human_handoff(self) -> None:
        ...
        self.assertEqual(
            stage8.inputs.get("stop_reason_optional"),
            touch_record.get("stop_reason_optional"),
        )
        self.assertEqual(
        ...
        self.assertIsNone(stage8.inputs.get("human_handoff_next_owner_role_optional"))
        self.assertIsNone(stage8.inputs.get("human_handoff_sla_hours_optional"))
        self.assertIsNone(stage8.inputs.get("human_handoff_reason_optional"))
    ...
    def test_stage8_h08_payload_and_writeback_projection_stay_authoritative_on_org_routed_handoff(self) -> None:
        payload = copy.deepcopy(load_fixture("internal_chain_happy.json"))
        payload.update(
            {
                "run_mode": "APPROVAL_RUN",
        ...
        self.assertEqual(
            stage8.handoff.get("human_handoff_reason_optional"),
            "organization_route_followup_required",
        )
        self.assertEqual(
            stage8.inputs.get("human_handoff_next_owner_role_optional"),
            stage8.handoff.get("human_handoff_next_owner_role_optional"),
        ...
        self.assertEqual(human_handoff.get("next_owner_role_optional"), "sales_user")
        self.assertEqual(human_handoff.get("sla_hours_optional"), 24)
        self.assertEqual(
            human_handoff.get("reason_optional"),
            "organization_route_followup_required",
        )
