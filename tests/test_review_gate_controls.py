...
class TestReviewGateControls(unittest.TestCase):
    ...
    def test_documents_use_new_system(self) -> None:
        ...
        action_matrix = read("control/automation_action_matrix.yaml")
        stop_conditions = read("control/automation_stop_conditions.yaml")
        self.assertIn("current_task -> product_task_library -> repo_status", agents)
        self.assertIn("START_HERE.md", agents)
        self.assertIn("DEV_MODE.md", agents)
        self.assertIn("MINIMAL_PRODUCT_PATH.md", agents)
        ...
        self.assertIn("DEV_MODE", task_rules)
        self.assertIn("TEST_MODE", task_rules)
        self.assertIn("PROD_LIVE_MODE", task_rules)
        self.assertIn("MINIMAL_PRODUCT_PATH.md", task_rules)
        self.assertIn("requires_task_packet: false", task_rules)
        self.assertIn("PROD_LIVE_MODE", action_matrix)
        self.assertIn("DEV_MODE and TEST_MODE are intentionally lightweight", stop_conditions)
