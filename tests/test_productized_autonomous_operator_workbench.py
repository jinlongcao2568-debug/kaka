...
class ProductizedAutonomousOperatorWorkbenchTests(
    ...
    def test_stage7_preview_exposes_owner_workbench_without_raw_json_dependency(self) -> None:
        ...
        self.assertIn("primary_evidence_topic_code", queue_item)
        self.assertIn("resolved_evidence_topic_codes", queue_item)
        self.assertIn("service_tier_code", queue_item)
        self.assertIn("package_template_code", queue_item)
