...
class TestStage12Extractors(unittest.TestCase):
    ...
    def test_planning_surfaces_keep_transition_safe_active_source_relationship(self) -> None:
        ...
        self.assertIn("当前 product mainline pool 内 S12/S23/S34/S45/S56/S67/S7/S78/S89/INT 与后主线 P1/P2/P3 均已 completed", task_library_text)
        self.assertIn("现在没有自动 next candidate", task_library_text)
        self.assertIn("P4 只允许后续人工/决策窗口通过 dedicated current_task packet 激活", task_library_text)
