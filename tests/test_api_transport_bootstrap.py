...
class TestApiTransportBootstrap(unittest.TestCase):
    ...
    def test_create_app_keeps_minio_object_storage_reserved_not_live(self) -> None:
        ...
        self.assertFalse(app.state.transport_bootstrap["controlled_opening_boundaries"]["minio_connection_enabled"])
        reserved_by_backend = {
            entry["backend"]: entry
            for entry in readiness["reserved_backends"]
        }
    ...
    def test_create_app_exposes_single_transport_bootstrap_readback_projection(self) -> None:
        ...
        self.assertTrue(
            model_assist_bootstrap["controlled_opening_boundaries"]["model_output_not_customer_conclusion"]
        )
        ...
        self.assertFalse(controlled_opening_boundaries["new_http_endpoint_added"])
        self.assertTrue(controlled_opening_boundaries["internal_stage1_to_stage6_http_endpoint_added"])
        self.assertFalse(controlled_opening_boundaries["new_external_or_live_http_endpoint_added"])
        self.assertFalse(controlled_opening_boundaries["stage1_to_stage5_real_transport_enabled"])
        self.assertFalse(controlled_opening_boundaries["stage1_to_stage5_external_live_transport_enabled"])
        self.assertFalse(controlled_opening_boundaries["external_software_release_enabled"])
        self.assertTrue(controlled_opening_boundaries["external_leadpack_delivery_requires_approval_and_audit"])
        ...
        self.assertFalse(controlled_opening_boundaries["provider_adapter_live_execution_enabled"])
        self.assertFalse(controlled_opening_boundaries["provider_adapter_provider_call_enabled"])
        self.assertFalse(controlled_opening_boundaries["provider_adapter_real_provider_call_enabled"])
        self.assertFalse(controlled_opening_boundaries["redis_connection_enabled"])
        self.assertFalse(controlled_opening_boundaries["external_queue_connection_enabled"])
        self.assertFalse(controlled_opening_boundaries["external_worker_process_enabled"])
        self.assertFalse(controlled_opening_boundaries["minio_connection_enabled"])
        self.assertFalse(controlled_opening_boundaries["s3_connection_enabled"])
        self.assertFalse(controlled_opening_boundaries["external_object_storage_connection_enabled"])
        ...
        self.assertFalse(controlled_opening_boundaries["migration_execution_enabled"])
        ...
        self.assertFalse(controlled_opening_boundaries["provider_credentials_plaintext_persisted"])
        ...
        self.assertFalse(controlled_opening_boundaries["automated_refund_program_present"])
        self.assertFalse(controlled_opening_boundaries["automated_refund_program_enabled"])
