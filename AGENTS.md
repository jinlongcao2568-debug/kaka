...
- 涉及“候选公示、评标结果、中标结果、候选人核查、真实竞争者、控标/围标/串标/陪标证据包、销售承接”的任务，默认走候选公示后证据包主线：先从后验阶段项目入池，再回溯同一项目全流程招标公告、招标文件、答疑澄清、开标、候选、结果和投标文件公开。
- 涉及“刚发公告、招标文件、是否值得投、投前预测、澄清/质疑”的任务，走投前预测线；该线不能输出候选人核查、真实竞争者结论或陪标组合结论。
