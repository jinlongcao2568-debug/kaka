...
| 3 | 待实施第一刀 | 下一步建立内部项目档案 trace，不替代原始证据 |
| 4 | 已完成第一刀，继续补强 | 已有附件完整性状态；下一步补附件语义角色、下载归档摘要和版本链状态 |
| 5 | 待实施 | 项目筛选、控标预测、自评分和废标红线暂未进入规则闭环 |
...
默认下一步先收口 **第 0 批映射基线状态**，然后推进 **第 3 批项目档案 + 第 4 批附件语义版本链**。
