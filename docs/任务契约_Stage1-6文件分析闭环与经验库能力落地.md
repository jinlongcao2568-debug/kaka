...
| 当前状态 | P1_B6_FIRST_CUT_IN_PROGRESS |
...
| 6 | 正在实施第一刀 | 在 Stage6 内部 trace 中收束公开核验、双闸门、B5 profile 和复核摘要 |
...
默认下一步推进 **第 6 批公开核验、双闸门与 Stage6 报告第一刀**：先把 Stage5 双闸门、review request 和 B5 主线风险 profile 汇总进 Stage6 内部报告 trace，不新增正式 D2/D3 对象、规则码、schema 或 migration。
