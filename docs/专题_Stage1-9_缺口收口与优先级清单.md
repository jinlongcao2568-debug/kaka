...
- 完成标准：
  ...
  - 编排状态能自动指向下一步 adapter job，并通过批次决策表、Stage6 action plan 和 Stage6 dispatch task 标出继续、暂存、复核和 Stage6/7 内部预览路径，避免真实项目“生成任务后靠人工记忆续跑”
