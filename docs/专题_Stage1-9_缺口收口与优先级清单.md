...
- 完成标准：
  ...
  - 下一步仍需补 GDCIC / 项目经理变更 browser-authorized readback，以及非广东归属地 adapter readback；不能因为广州住建 API 已通就误判四类释放证据都已实战稳定
