...
1. 先做 Stage6 多项目/多批次总览 UI，让 owner 看懂项目跑到哪、为什么停、下一步是什么。
2. 再做 Stage4 释放证据主链，把施工许可、竣工验收、项目经理变更、合同履约收成统一 adapter job。
